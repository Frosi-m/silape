    ...
    <div class="rectangle_edit_user">
        ...
        @foreach ($data_u as $data)
            ...
            <form action="{{ route('proses_edit') }}" method="POST">
                ...
                @error('nama_user')
                    <small style="color: red;font-style: italic; position: relative; top: 85px; left: 38px;">Nama
                        harap diisi
                        dengan benar*</small>
                @enderror
                ...
                @error('tela')
                    <small style="color: red;font-style: italic; position: relative; top: 85px; left: 38px;">Tempat lahir
                        harap diisi
                        dengan benar*</small>
                @enderror
                ...
                @error('tala')
                    <small style="color: red;font-style: italic; position: relative; top: 85px; left: 38px;">Tanggal lahir
                        harap diisi
                        dengan benar*</small>
                @enderror
